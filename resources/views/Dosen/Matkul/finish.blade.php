    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="finishLabel">Atur Waktu Ujian</h1>
            ...
            <div class="modal-body">
                <form id="formfinish" enctype="multipart/form-data" action="/dosen/finish/{{ $matkul->id }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="finish_date" class="form-control" name="finish_date" value="{{ $matkul->finish_date }}">
                    </div>
                    <div class="mb-3">
                        <label for="finish_time" class="form-label">Jam Selesai</label>
                        <input type="time" id="finish_time" class="form-control" name="finish_time" value="{{ $matkul->finish_time }}">
                    </div>
            </div>
